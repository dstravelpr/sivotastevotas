const events = [
  ...
  { year: '2019', title: 'El Verano del \'19', desc: 'Se filtra un chat de Telegram del gobernador Ricardo Rosselló y su círculo cercano. Entre los mensajes, Rosselló escribió: "Cogemos de pendejo hasta los nuestros" — desprecio hasta por quienes votaron por él. Cientos de miles salen a la calle en la mayor protesta de nuestra historia y Rosselló renuncia. Nadie lo destituyó: renunció. Sin mecanismo de revocación, la calle fue la única salida.' },
